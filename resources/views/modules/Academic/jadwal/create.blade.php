    ...
    <div class="p-4 md:p-8 overflow-y-auto pb-24 md:pb-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h2 class="font-headline-xl text-headline-xl font-bold text-on-surface">Tambah Jadwal Kuliah</h2>
            </div>
            <p class="font-body-sm text-body-sm text-on-surface-variant ml-7">Alokasikan mata kuliah, dosen, kelas, dan waktu perkuliahan.</p>
        </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select id="mata_kuliah_id" name="mata_kuliah_id" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" required autofocus>
                                        ...
                                        @foreach ($mataKuliah as $mata)
                                            <option value="{{ $mata->id }}" {{ old('mata_kuliah_id') == $mata->id ? 'selected' : '' }}>{{ $mata->kode }} - {{ $mata->nama }} ({{ $mata->sks }} SKS)</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="kelas_id" name="kelas_id" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" required>
                                        ...
                                        @foreach ($kelas as $kelasItem)
                                            <option value="{{ $kelasItem->id }}" {{ old('kelas_id') == $kelasItem->id ? 'selected' : '' }}>{{ $kelasItem->nama_kelas }} ({{ $kelasItem->angkatan }})</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input id="ruangan" name="ruangan" type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors uppercase" value="{{ old('ruangan') }}" placeholder="Misal: A101" required />
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input id="jam_mulai" name="jam_mulai" type="time" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors font-numeric-token" value="{{ old('jam_mulai') }}" required />
                                    ...
                                    <div>
                                        ...
                                        <input id="jam_selesai" name="jam_selesai" type="time" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors font-numeric-token" value="{{ old('jam_selesai') }}" required />
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="tahun_ajaran" name="tahun_ajaran" type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors font-numeric-token" value="{{ old('tahun_ajaran', date('Y') . '/' . (date('Y') + 1)) }}" placeholder="Contoh: 2023/2024" required />
