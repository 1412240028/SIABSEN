<x-app-layout>
    ...
    <div class="p-4 lg:p-8 overflow-y-auto pb-24 md:pb-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
                <h2 class="font-headline-2xl text-headline-2xl font-bold text-on-surface">
                    {{ $salutation }}, {{ $mahasiswa->nama ?? auth()->user()->name }}
                </h2>
                <p class="font-body-base text-body-base text-on-surface-variant mt-1">
                    Semester Ganjil 2024/2025 • {{ $mahasiswa->kelas->nama_kelas ?? '-' }}
                </p>
            </div>
            <a href="{{ route('mahasiswa.presensi.scan.form') }}" class="bg-secondary-container hover:bg-secondary-fixed-dim text-on-secondary-container font-label-medium text-label-medium px-6 py-3 rounded-xl flex items-center gap-2 shadow-card transition-all transform hover:-translate-y-0.5 active:translate-y-0">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
            ...
            <!-- Stats Bento -->
            <div class="xl:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <!-- Announcements -->
            <div class="xl:col-span-4 bg-white rounded-xl border border-slate-200 shadow-soft overflow-hidden flex flex-col h-full">
            ...
            <!-- Schedule Table -->
            <div class="xl:col-span-8 bg-white rounded-xl border border-slate-200 shadow-soft overflow-hidden flex flex-col h-full">
                <div class="p-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
            ...
            <!-- Quick Actions -->
            <div class="xl:col-span-4 bg-primary rounded-xl p-card-padding text-white shadow-card relative overflow-hidden">
