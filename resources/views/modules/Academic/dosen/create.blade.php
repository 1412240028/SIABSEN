    ...
    <div class="p-4 md:p-8 overflow-y-auto pb-24 md:pb-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h2 class="font-headline-xl text-headline-xl font-bold text-on-surface">Tambah Dosen</h2>
            </div>
            <p class="font-body-sm text-body-sm text-on-surface-variant ml-7">Tambahkan data dosen baru beserta akun akses ke dalam sistem.</p>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input id="email" name="email" type="email" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" value="{{ old('email') }}" placeholder="Contoh: dosen@kampus.ac.id" required />
                                    <x-input-error :messages="$errors->get('email')" class="mt-2 text-error text-xs" />
                                </div>

                                <!-- Password -->
                                <div>
                                    <label for="password" class="block font-label-medium text-label-medium text-on-surface mb-2">Password Akses <span class="text-error">*</span></label>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input id="name" name="name" type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" value="{{ old('name') }}" placeholder="Contoh: Dr. Budi Santoso, M.Kom" required autofocus />
                                ...
                                <div>
                                    ...
                                    <input id="nidn" name="nidn" type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors font-numeric-token" value="{{ old('nidn') }}" placeholder="Nomor Induk Dosen Nasional" required />
                                ...
                                <div>
                                    ...
                                    <textarea id="alamat" name="alamat" rows="4" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" placeholder="Masukkan alamat domisili dosen...">{{ old('alamat') }}</textarea>
