            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('mahasiswa.update', $mahasiswa) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" value="{{ old('name', $mahasiswa->nama) }}" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="tanggal_lahir" name="tanggal_lahir" type="date" class="mt-1 block w-full" value="{{ old('tanggal_lahir', $mahasiswa->tanggal_lahir?->format('Y-m-d')) }}" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="alamat" name="alamat" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" rows="4">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                        <x-input-error :messages="$errors->get('alamat')" class="mt-2" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="angkatan" value="Angkatan" />
                        <x-text-input id="angkatan" name="angkatan" type="number" class="mt-1 block w-full" value="{{ old('angkatan', $mahasiswa->angkatan) }}" required />
