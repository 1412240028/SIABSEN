    ...
    <div class="p-4 md:p-8 overflow-y-auto pb-24 md:pb-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h2 class="font-headline-xl text-headline-xl font-bold text-on-surface">Edit Kelas</h2>
            </div>
            <p class="font-body-sm text-body-sm text-on-surface-variant ml-7">Perbarui data kelas {{ $kelas->nama_kelas }}.</p>
        </div>
                ...
                <form method="POST" action="{{ route('kelas.update', $kelas) }}">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input id="nama_kelas" name="nama_kelas" type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" placeholder="Contoh: TI24A" required autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="angkatan" name="angkatan" type="number" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" value="{{ old('angkatan', $kelas->angkatan) }}" required />
                            ...
                            <div>
                                ...
                                <input id="kapasitas" name="kapasitas" type="number" class="w-full px-4 py-2 border border-outline-variant rounded-lg text-body-sm focus:border-primary focus:ring-1 focus:ring-primary bg-white transition-colors" value="{{ old('kapasitas', $kelas->kapasitas) }}" required />
